...
class AdditionalFiltersSelect
{
    ...
    public function aroundGetDataSet(
        ...
        if ($bucket->getField() == AdditionalFiltersConfig::NEW_FILTER
        ...
        if ($bucket->getField() == AdditionalFiltersConfig::ON_SALE_FILTER
            && ($currentScope = $this->filterNewService->getCurrentScope($dimensions))
        ...
        if ($bucket->getField() == AdditionalFiltersConfig::STOCK_FILTER
        ...
        if ($bucket->getField() == AdditionalFiltersConfig::RATING_FILTER
