...
namespace Mirasvit\LayeredNavigation\Block\Adminhtml\Product\Attribute\Edit\Tab\Fieldset;
...
class VisibilityFieldset extends Fieldset
{
    ...
    public function __construct(
        ...
        DisplayInCategoriesOptions $displayInCategoriesOptions,
        ...
        $this->displayInCategoriesOptions   = $displayInCategoriesOptions;
    ...
    public function getBasicChildrenHtml()
    {
        ...
        $attribute = $this->attribute->load($this->request->getParam('attribute_id'));
        if ($attribute->getFrontendInput() == 'select') {
            $displayAsField = $this->addField(
                AttributeConfigInterface::CATEGORY_DISPLAY_MODE,
                'select',
                [
                    'name'   => AttributeConfigInterface::CATEGORY_DISPLAY_MODE,
                    'label'  => __('Display On Category Page As'),
                    'values' => $this->displayInCategoriesOptions->toOptionArray(),
                    'value'  => $this->attributeConfig->getCategoryDisplayMode(),
                ]
            );
        }
