...
class NewFilter extends AbstractFilter
{
     ...
     * @var string
     */
    protected $attributeCode = AdditionalFiltersConfig::NEW_FILTER;
    ...
    public function __construct(
        ...
        $this->_requestVar             = AdditionalFiltersConfig::NEW_FILTER_FRONT_PARAM;
    ...
    public function apply(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $filter = $request->getParam(AdditionalFiltersConfig::NEW_FILTER_FRONT_PARAM);
    ...
    public function getName()
    {
        ...
        $newName = ($newName) ? : AdditionalFiltersConfig::NEW_FILTER_DEFAULT_LABEL;
