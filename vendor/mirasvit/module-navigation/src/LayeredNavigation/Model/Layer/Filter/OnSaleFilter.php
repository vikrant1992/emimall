...
class OnSaleFilter extends AbstractFilter
{
     ...
     * @var string
     */
    protected $attributeCode = AdditionalFiltersConfig::ON_SALE_FILTER;
    ...
    public function __construct(
        ...
        $this->_requestVar             = AdditionalFiltersConfig::ON_SALE_FILTER_FRONT_PARAM;
    ...
    public function apply(\Magento\Framework\App\RequestInterface $request)
    {
        ...
        $filter = $request->getParam(AdditionalFiltersConfig::ON_SALE_FILTER_FRONT_PARAM);
    ...
    public function getName()
    {
        ...
        $saleName = ($saleName) ? : AdditionalFiltersConfig::ON_SALE_FILTER_DEFAULT_LABEL;
